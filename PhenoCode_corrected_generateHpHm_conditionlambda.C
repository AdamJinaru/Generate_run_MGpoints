...
void PhenoCode_corrected_generateHpHm_conditionlambda(){ 
SetPlotStyle();
...
RKComputeMasses2_Hpp(0.0008,0.1,246,0.1, 0.2, 0.3, 0.4, 220. ,1., 220, 1., option_fixed, option_vary_lambda,0);
//RKComputeMasses2_Hpp(0.001,0.1,246,0.1, 0.2, 0.3, 0.4, 200. ,1., 200., 1., option_fixed, option_vary_lambda,0);
...
for(int mass=std::max<double>(-20, Deltam_lower);mass<=std::min<double>(20,Deltam_upper);mass++){
...
eff_file_e<<"output pp_HpHm_H++"+mHpp_char+"_"+mp_contor_found_char<<std::endl;
eff_file_e<<"launch"<<std::endl;
eff_file_e<<"set nevents 1"<<std::endl;
